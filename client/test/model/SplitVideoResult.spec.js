...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveVideoApiClient.SplitVideoResult();
  });
  ...
  describe('SplitVideoResult', function() {
    it('should create an instance of SplitVideoResult', function() {
      // uncomment below and update the code to test SplitVideoResult
      //var instance = new CloudmersiveVideoApiClient.SplitVideoResult();
      //expect(instance).to.be.a(CloudmersiveVideoApiClient.SplitVideoResult);
    });
